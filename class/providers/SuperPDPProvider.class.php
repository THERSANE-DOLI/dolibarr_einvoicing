...
class SuperPDPProvider extends AbstractPDPProvider
{
	...
	public function getRemoteInfo()
	{
		...
		if ($directory['status_code'] == 200) {
			...
			$lines[] = $langs->trans('RemoteInfoPPFDetection', 'SuperPDP', $paName) . ' ['. $directory['ppf_identifier'] . ' - ' . $langs->trans('RemoteInfoPPFStatusDetail', $directory['ppf_status']) . ' - ' . $directory['ppf_effective_date'].']';
		} else {
